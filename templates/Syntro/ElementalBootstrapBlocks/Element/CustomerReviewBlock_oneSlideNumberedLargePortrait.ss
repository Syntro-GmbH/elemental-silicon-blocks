    ...
    <div class="col-md-4 d-none d-md-block">
      ...
      <div class="swiper-tabs">
        <% loop Reviews %>
          ...
          <div class="card-body p-0 rounded-3 bg-size-cover bg-repeat-0 bg-position-top-center" style="background-image: url(<% if Portrait %>$Portrait.ScaleWidth(600).URL<% else %>$resourceURL('syntro/blocks-silicon:client/img/user-placeholder.png')<% end_if %>);">
            </div>
